...
import styles from './InfoPage5.style';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.btn_container}>
        <FloatingButton icon="arrow-right" onPress={goToInfoPage6}/>
      </View>
    </View>
  );
}
